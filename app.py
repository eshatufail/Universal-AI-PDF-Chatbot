...
st.markdown("""
    ...
    .stButton>button { background-color: #4a5d4e; color: white; border-radius: 10px; }
...
# --- Keys (Use Streamlit Secrets for deployment) ---
    ...
    if uploaded_file and st.button("Analyze PDF"):
        with st.spinner("Reading document..."):
            ...
            try:
                ...
                # Using Gemini Embeddings with Task Type for stability
...
if prompt := st.chat_input("Ask about the PDF..."):
    ...
    If not in context, answer generally. Mention tone at the end.
    Context: {context}
    Question: {question}
    Answer:"""
